...
for k = 1:26
    ...
    for i=1:360
        ...
        res(i,:)=sub_optimal_attack_2(i,k-1,mv,rss,ru,rpc,xu); % this include 2 versions
    end
    avg2(k)= mean(res(1:360,2));
    universe2(:,:,k)=res; % k layer
end

save ./mat/type2.mat universe2 avg2;

% clear
% load avg_subopt_db_0.mat
% load avg_subopt_db_1.mat
plot(avg2,'-ro','markersize',7,'linewidth',2)
xlim([0,25])
